...
cd -
zip -q -X -r ${PACKAGE}.zip ${APPLICATION} -x \*/.idea/\* \*/.gitignore \*/.git/\* \*.iml ${APPLICATION}/conf/nxt-default.properties ${APPLICATION}/conf/logging-default.properties ${APPLICATION}/conf/localstorage/\*
rm -rf ${APPLICATION}

echo creating change log ${CHANGELOG}
echo -e "Release $1\n" > ${CHANGELOG}
echo -e "https://www.birdlance.com/\n" >> ${CHANGELOG}
